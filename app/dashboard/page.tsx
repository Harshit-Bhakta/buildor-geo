  ...
  return (
    <div style={{ ...cardBaseStyle, backgroundColor: 'rgba(17, 24, 39, 0.95)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
        ...
        <h4 style={{ fontSize: '16px', fontWeight: 600, margin: 0 }}>nkilhex</h4>
      </div>
      ...
      <div style={{ display: 'flex', gap: '24px', marginBottom: '12px' }}>
        <div>
          <div style={{ fontSize: '24px', fontWeight: 700, color: 'white' }}>32</div>
          <div style={{ fontSize: '11px', color: 'rgba(255, 255, 255, 0.6)' }}>Public Repos</div>
        </div>
        <div>
          <div style={{ fontSize: '24px', fontWeight: 700, color: 'white' }}>8</div>
